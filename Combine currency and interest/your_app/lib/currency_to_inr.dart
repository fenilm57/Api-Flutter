...
class CADToINR extends StatefulWidget {
  @override
  _CADToINRState createState() => _CADToINRState();
}

class _CADToINRState extends State<CADToINR> {
  int amount;
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButton<String>(
                  ...
                  items: <String>['INR', 'USD', 'EUR', 'Pounds', 'THB']
                ...
                (currency == "GBP")
                    ...
                    : Text(
                        '${choosenCurrency.text} $currency In CAD is $result',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 30.0,
                          fontWeight: FontWeight.bold,
